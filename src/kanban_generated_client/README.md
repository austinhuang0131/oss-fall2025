...
```python
from kanban_generated_client import Client
...
```python
from kanban_generated_client import AuthenticatedClient
...
```python
from kanban_generated_client.models import MyDataModel
from kanban_generated_client.api.my_tag import get_my_data_model
from kanban_generated_client.types import Response
...
1. Any endpoint which did not have a tag will be in `kanban_generated_client.api.default`
