"""Concrete models for KanbanClientAdapter."""
...
class AdapterBoard(KanbanBoard):
    """Concrete implementation of KanbanBoard for KanbanClientAdapter."""
...
class AdapterList(KanbanList):
    """Concrete implementation of KanbanList for KanbanClientAdapter."""
...
class AdapterCard(KanbanCard):
    """Concrete implementation of KanbanCard for KanbanClientAdapter."""
...
class AdapterUser(KanbanUser):
    """Concrete implementation of KanbanUser for KanbanClientAdapter."""
